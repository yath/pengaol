 ...
 *
 * Revision 1.3  1997/04/22 00:37:56  wwg
 * Patched to update the RIFF block size, after patching
 * the data block size, when the xltwavplay client
 * terminates the recording session. This is a temp. fix
 * until a real RIFF block module is added to this suite.
 *
