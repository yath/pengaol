...
CData->dat2="10,10,a0,44,64,0,16,0,1,0,1,a,4,0,0,0,1,1,b,4,0,0,0,2,3,1,%c,%s,1,1d,0,1,1d,0,1,a,4,0,0,0,2,3,1,%c,%s,1,1d,0,0,2,0";
...
CData->dat10="23,17,a0,79,63,0e,3c,45,0,0,3c,14,0,0,0,20,1,97,90,a0,a6,20,d5,c3,65,5e,50,8,0,3f,5c,1,0,d,0,61,62,63,64,65,66,67,68,69,6a,6b,6c,6d,6e,6f,70,71,72,73,74,75,76,77,61,62,63,64,65,66,67,68,69";
CData->dat11="14,1e,a0,79,63,0,1c,45,0,0,1c,0,0,0,0,80,1,ed,6e,ac,8d,c0,e2,e0,0,0,2,a,0,f5,ff,0,0,0,0";
CData->dat12="15,20,a0,79,63,0,1c,45,0,0,1c,1,0,0,0,80,1,ec,6e,ac,8d,c0,e2,e0,00,00,02,a0,0,f5,ff,0,0,0,0";
CData->dat13="16,20,a0,79,63,0,1c,45,0,0,1c,02,0,0,0,80,1,eb,6e,ac,8d,c0,e2,e0,0,0,2,a0,0,f5,ff,0,0,0,0";
...
if (nSize<(MaxBuffer-5))
	...
	for (i=0;i<(nRet-1);i++)
		m_cMsgIn->Printf("%L0x%x,",(unsigned char) sStartBuffer[i+5]);
...
int Kernel30::ReadAolTrameSeqAck(char *buffer,int nBufferSize,int nSeq,int nAck)
{
int i;
int nSize=4;
int nSRead=0;
